...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Vandana Yadav — 3D Portfolio" },
      { property: "og:description", content: "MBA Finance · Team leader of 153+ · Trained 1,500+ · AI generative marketing & B2B strategy." },
